...
1. [Copy the original template](https://github.com/ISSAE/architect/blob/master/_layouts/default.html) from the theme's repository<br />(*Pro-tip: click "raw" to make copying easier*)
